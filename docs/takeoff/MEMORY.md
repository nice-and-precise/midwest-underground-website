...
## Table of Contents
  ...
  - [Overview](#overview)
    - [What is Serena Memory?](#what-is-serena-memory)
    - [Why Use Serena for Takeoff System?](#why-use-serena-for-takeoff-system)
    - [Core Concepts](#core-concepts)
  - [Memory Architecture](#memory-architecture)
    - [Three-Layer Knowledge Model](#three-layer-knowledge-model)
    - [Token Budget Optimization](#token-budget-optimization)
  - [Primary Memories](#primary-memories)
    - [1. System Context Entity](#1-system-context-entity)
    - [2. Progress Tracker Entity](#2-progress-tracker-entity)
    - [3. Module State Entities](#3-module-state-entities)
  - [Update Patterns](#update-patterns)
    - [Pattern 1: Module Initialization](#pattern-1-module-initialization)
    - [Pattern 2: Task Completion Update](#pattern-2-task-completion-update)
    - [Pattern 3: Module Completion](#pattern-3-module-completion)
    - [Pattern 4: Blocker Recording](#pattern-4-blocker-recording)
  - [Memory Structure Examples](#memory-structure-examples)
    - [Example 1: System Context Entity (Full)](#example-1-system-context-entity-full)
    - [Example 2: Progress Tracker Entity (Full)](#example-2-progress-tracker-entity-full)
    - [Example 3: Module State Entity (Full)](#example-3-module-state-entity-full)
  - [Best Practices](#best-practices)
    - [For Autonomous Agents](#for-autonomous-agents)
      - [1. Read Before Write](#1-read-before-write)
      - [2. Update After Every Task](#2-update-after-every-task)
      - [3. Use Structured Data for Lists](#3-use-structured-data-for-lists)
      - [4. Include Timestamps](#4-include-timestamps)
      - [5. Clear Blockers When Resolved](#5-clear-blockers-when-resolved)
    - [For Human Developers](#for-human-developers)
      - [Query State Between Sessions](#query-state-between-sessions)
- [Check current progress](#check-current-progress)
- [Check specific module](#check-specific-module)
- [Find all completed modules](#find-all-completed-modules)
      - [Manual State Corrections](#manual-state-corrections)
  - [Access Patterns](#access-patterns)
    - [Session Start Pattern](#session-start-pattern)
    - [Search Pattern](#search-pattern)
    - [Relation Pattern (Optional Advanced Use)](#relation-pattern-optional-advanced-use)
  - [Migration and Maintenance](#migration-and-maintenance)
    - [When to Archive Old State](#when-to-archive-old-state)
- [Serena State Archive - Phase 1](#serena-state-archive-phase-1)
  - [Module 1.1 - PDF Viewer](#module-11-pdf-viewer)
  - [Module 1.2 - Measurement Tools](#module-12-measurement-tools)
    - [Schema Evolution](#schema-evolution)
  - [Validation Results (P0.2)](#validation-results-p02)
    - [Test Coverage](#test-coverage)
      - [1. Memory Write Operations ✅](#1-memory-write-operations)
      - [2. Memory Read Operations ✅](#2-memory-read-operations)
    ...
    - [Integration with Takeoff System](#integration-with-takeoff-system)
