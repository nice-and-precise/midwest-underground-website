...
## Table of Contents
  ...
  - [Naming Conventions](#naming-conventions)
    ...
    - [Test Suite Names](#test-suite-names)
    - [Test Names](#test-names)
  - [When to Write Tests](#when-to-write-tests)
    - [Test-Driven Development (TDD)](#test-driven-development-tdd)
    - [Per-Module Testing Checklist](#per-module-testing-checklist)
  - [Test Data Management](#test-data-management)
    - [Fixtures Strategy](#fixtures-strategy)
    - [Test Data Isolation](#test-data-isolation)
    - [Mock Data Generation](#mock-data-generation)
  - [Running Tests](#running-tests)
    - [Command Reference](#command-reference)
    - [Test Scripts (package.json)](#test-scripts-packagejson)
  - [Test Coverage Goals](#test-coverage-goals)
    - [Coverage Targets](#coverage-targets)
    - [Coverage Tracking](#coverage-tracking)
- [Test Results](#test-results)
  - [Examples](#examples)
    - [Example 1: PDF Viewer Test](#example-1-pdf-viewer-test)
    - [Example 2: Measurement Tools Test](#example-2-measurement-tools-test)
    - [Example 3: End-to-End Workflow Test](#example-3-end-to-end-workflow-test)
  - [Debugging Failed Tests](#debugging-failed-tests)
    - [Common Issues and Solutions](#common-issues-and-solutions)
    - [Debug Tools](#debug-tools)
  - [Playwright Setup and Usage](#playwright-setup-and-usage)
    - [Installation and Configuration](#installation-and-configuration)
- [Install Playwright test package](#install-playwright-test-package)
- [Install browsers (Chromium, Firefox, WebKit)](#install-browsers-chromium-firefox-webkit)
- [Or install specific browser only](#or-install-specific-browser-only)
- [Check Playwright version](#check-playwright-version)
- [Run sample test](#run-sample-test)
...
- [Re-run tests on file change](#re-run-tests-on-file-change)
- [Run in specific browser](#run-in-specific-browser)
- [Run tests in parallel (default)](#run-tests-in-parallel-default)
...
- [Run with browser open](#run-with-browser-open)
- [Pause on failure](#pause-on-failure)
- [Run with trace](#run-with-trace)
