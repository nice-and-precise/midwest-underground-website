...
## Table of Contents
  ...
  - [Implementation Plan Outline](#implementation-plan-outline)
    - [Task 1: Install and Configure Playwright](#task-1-install-and-configure-playwright)
    - [Task 2: Create Sample Test](#task-2-create-sample-test)
    - [Task 3: Verify Screenshot Capture](#task-3-verify-screenshot-capture)
    - [Task 4: Document Testing Conventions](#task-4-document-testing-conventions)
    - [Task 5: Create Test Scripts](#task-5-create-test-scripts)
  ...
  - [Testing](#testing)
- [Run all tests (headless)](#run-all-tests-headless)
- [Run with browser UI visible](#run-with-browser-ui-visible)
- [Debug mode (step through test)](#debug-mode-step-through-test)
