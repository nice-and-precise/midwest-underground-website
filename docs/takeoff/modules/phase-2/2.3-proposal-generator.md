...
- [Data Schema](#data-schema)
  - [proposals.json Structure](#proposalsjson-structure)
  - [Field Definitions](#field-definitions)
- [Dependencies](#dependencies)
- [Skills Needed](#skills-needed)
- [Constraints](#constraints)
- [jsPDF Template Structure](#jspdf-template-structure)
  - [Proposal Template API](#proposal-template-api)
...
- [PDF Output Example](#pdf-output-example)
  - [Cover Page Layout](#cover-page-layout)
  - [Cost Breakdown Page (Detailed)](#cost-breakdown-page-detailed)
