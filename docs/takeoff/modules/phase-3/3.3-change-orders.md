...
- [Key Behaviors](#key-behaviors)
  - [Behavior 1: Change Order Creation](#behavior-1-change-order-creation)
  - [Behavior 2: Scope Change Interface](#behavior-2-scope-change-interface)
  - [Behavior 3: Delta Calculation Engine](#behavior-3-delta-calculation-engine)
  - [Behavior 4: Schedule Impact Tracking](#behavior-4-schedule-impact-tracking)
  - [Behavior 5: CO Workflow State Machine](#behavior-5-co-workflow-state-machine)
  - [Behavior 6: Estimate Update on Approval](#behavior-6-estimate-update-on-approval)
  - [Behavior 7: Change Order PDF Generation](#behavior-7-change-order-pdf-generation)
  - [Behavior 8: Change Order History & Audit Trail](#behavior-8-change-order-history-audit-trail)
...
- [Research Needed](#research-needed)
  - [1. Change Order Workflow Design](#1-change-order-workflow-design)
  - [2. Estimate Update Strategy](#2-estimate-update-strategy)
  - [3. Delta Calculation Rules](#3-delta-calculation-rules)
  - [4. PDF Document Format](#4-pdf-document-format)
...
- [Integration Points](#integration-points)
  ...
  - [With Module 3.2 (Historical Database)](#with-module-32-historical-database)
