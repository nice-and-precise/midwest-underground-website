...
- [Key Behaviors](#key-behaviors)
  - [Behavior 1: Simple Authentication System](#behavior-1-simple-authentication-system)
  - [Behavior 2: Client Dashboard](#behavior-2-client-dashboard)
  - [Behavior 3: Project Detail View](#behavior-3-project-detail-view)
  - [Behavior 4: Proposal Viewer & Approval](#behavior-4-proposal-viewer-approval)
  - [Behavior 5: File Upload System](#behavior-5-file-upload-system)
  - [Behavior 6: Read-Only Takeoff View](#behavior-6-read-only-takeoff-view)
  - [Behavior 7: Activity & Audit Log](#behavior-7-activity-audit-log)
  - [Behavior 8: Access Control](#behavior-8-access-control)
...
- [Skills Needed](#skills-needed)
  ...
  - [Security Knowledge (CRITICAL)](#security-knowledge-critical)
  - [Research Areas (To Be Investigated During Planning)](#research-areas-to-be-investigated-during-planning)
- [Constraints](#constraints)
  - [Technical Constraints](#technical-constraints)
  - [Security Constraints (CRITICAL)](#security-constraints-critical)
  - [User Experience Constraints](#user-experience-constraints)
- [Research Needed](#research-needed)
  - [1. File Upload Size Limits](#1-file-upload-size-limits)
  - [2. Session Management](#2-session-management)
  - [3. Proposal Approval Workflow](#3-proposal-approval-workflow)
  - [4. Access Control Edge Cases](#4-access-control-edge-cases)
...
- [Integration Points](#integration-points)
  ...
  - [With Module 1.4 (Export/Persistence)](#with-module-14-exportpersistence)
  - [With Module 3.3 (Change Orders)](#with-module-33-change-orders)
- [Security Considerations (CRITICAL)](#security-considerations-critical)
  - [⚠️ WARNING: This Module Is NOT Secure](#warning-this-module-is-not-secure)
  - [Known Security Vulnerabilities](#known-security-vulnerabilities)
  - [Mitigation (For Production Use)](#mitigation-for-production-use)
