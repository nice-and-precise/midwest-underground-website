...
- [FEATURE REQUEST: Invoice Payment System](#feature-request-invoice-payment-system)
  - [Context](#context)
  - [Feature Requirements](#feature-requirements)
  - [Payment Flow](#payment-flow)
  - [Implementation Approach](#implementation-approach)
    - [MVP/Simulation Mode (Start Here)](#mvpsimulation-mode-start-here)
    - [Production Mode (Phase 2)](#production-mode-phase-2)
  - [Technical Specifications](#technical-specifications)
  - [Integration Points](#integration-points)
  - [Success Metrics](#success-metrics)
  - [Quality Gates](#quality-gates)
  - [System Architecture](#system-architecture)
    - [MVP/Simulation Architecture](#mvpsimulation-architecture)
    - [Production Architecture](#production-architecture)
  - [Stripe Integration Details](#stripe-integration-details)
    - [Step 1: Stripe Account Setup](#step-1-stripe-account-setup)
    - [Step 2: Environment Configuration](#step-2-environment-configuration)
- [.env file (add to .gitignore!)](#env-file-add-to-gitignore)
    - [Step 3: Install Stripe.js](#step-3-install-stripejs)
    - [Step 4: Initialize Stripe Elements](#step-4-initialize-stripe-elements)
    - [Step 5: Payment Intent Flow](#step-5-payment-intent-flow)
  - [Detailed Implementation Steps](#detailed-implementation-steps)
    - [Phase 1: MVP/Simulation Mode (Start Here)](#phase-1-mvpsimulation-mode-start-here)
      - [Step 1: Create HTML Structure (30 minutes)](#step-1-create-html-structure-30-minutes)
      - [Step 2: Create Payment Success Page (15 minutes)](#step-2-create-payment-success-page-15-minutes)
      - [Step 3: Create Payment Styles (45 minutes)](#step-3-create-payment-styles-45-minutes)
      - [Step 4: Create Payment JavaScript (MVP - 90 minutes)](#step-4-create-payment-javascript-mvp-90-minutes)
      - [Step 5: Create Success Page JavaScript (20 minutes)](#step-5-create-success-page-javascript-20-minutes)
    - [Phase 2: Production Implementation](#phase-2-production-implementation)
      - [Backend Requirements](#backend-requirements)
- [.env](#env)
  - [Code Examples](#code-examples)
    - [Production Stripe Integration](#production-stripe-integration)
    - [Error Handling](#error-handling)
    - [Invoice Lookup with Validation](#invoice-lookup-with-validation)
  - [Security Best Practices](#security-best-practices)
    - [1. API Key Management](#1-api-key-management)
    - [2. HTTPS Requirements](#2-https-requirements)
- [Nginx HTTPS redirect](#nginx-https-redirect)
- [Strong SSL configuration](#strong-ssl-configuration)
    - [3. Input Validation](#3-input-validation)
    - [4. PCI Compliance](#4-pci-compliance)
  ...
  - [Troubleshooting](#troubleshooting)
    - [Issue: "Stripe is not defined"](#issue-stripe-is-not-defined)
    - [Issue: Payment fails with "Invalid API Key"](#issue-payment-fails-with-invalid-api-key)
    - [Issue: Webhook not receiving events](#issue-webhook-not-receiving-events)
- [Test webhook locally with Stripe CLI](#test-webhook-locally-with-stripe-cli)
    - [Issue: Payment succeeds but invoice not marked paid](#issue-payment-succeeds-but-invoice-not-marked-paid)
    - [Issue: Card validation failing for valid cards](#issue-card-validation-failing-for-valid-cards)
    - [Issue: Success page shows "No payment data"](#issue-success-page-shows-no-payment-data)
    - [Issue: Mobile users can't complete payment](#issue-mobile-users-cant-complete-payment)
    - [Issue: High rate of abandoned payments](#issue-high-rate-of-abandoned-payments)
