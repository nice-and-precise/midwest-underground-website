...
## Table of Contents
  ...
  - [Pre-Deployment Checklist](#pre-deployment-checklist)
    ...
    - [SEO Preparation](#seo-preparation)
    - [Performance Check](#performance-check)
  - [Netlify Deployment (Recommended)](#netlify-deployment-recommended)
    - [Option A: Drag & Drop (Easiest)](#option-a-drag-drop-easiest)
    - [Option B: Git Integration (Best for Updates)](#option-b-git-integration-best-for-updates)
- [Navigate to project directory](#navigate-to-project-directory)
- [Initialize git (if not already done)](#initialize-git-if-not-already-done)
- [Add all files](#add-all-files)
- [Commit](#commit)
- [Create GitHub repository at https://github.com/new](#create-github-repository-at-httpsgithubcomnew)
- [Name it: midwest-underground-website](#name-it-midwest-underground-website)
- [Add remote and push](#add-remote-and-push)
    - [Option C: Netlify CLI](#option-c-netlify-cli)
- [Initialize (first time only)](#initialize-first-time-only)
- [Follow prompts:](#follow-prompts)
- [- Create & configure new site](#create-configure-new-site)
- [- Choose team](#choose-team)
- [- Site name: midwest-underground](#site-name-midwest-underground)
- [- Build command: (leave empty)](#build-command-leave-empty)
...
- [Login (opens browser)](#login-opens-browser)
- [Deploy](#deploy)
- [Follow prompts:](#follow-prompts)
- [- Set up and deploy: Y](#set-up-and-deploy-y)
- [- Which scope: Your account](#which-scope-your-account)
- [- Link to existing project: N](#link-to-existing-project-n)
- [- Project name: midwest-underground](#project-name-midwest-underground)
- [- In which directory: ./ (just press Enter)](#in-which-directory-just-press-enter)
- [- Override settings: N](#override-settings-n)
- [Deploy to production](#deploy-to-production)
    - [Option B: Vercel Dashboard](#option-b-vercel-dashboard)
  - [GitHub Pages Deployment](#github-pages-deployment)
    - [Step 1: Create Repository](#step-1-create-repository)
    - [Step 2: Push Code](#step-2-push-code)
    - [Step 3: Enable GitHub Pages](#step-3-enable-github-pages)
    - [Step 4: Custom Domain (Optional)](#step-4-custom-domain-optional)
  - [Custom Domain Configuration](#custom-domain-configuration)
    - [Purchase Domain](#purchase-domain)
    - [DNS Configuration for Netlify](#dns-configuration-for-netlify)
    - [DNS Configuration for Vercel](#dns-configuration-for-vercel)
    - [DNS Configuration for GitHub Pages](#dns-configuration-for-github-pages)
  - [Post-Deployment Tasks](#post-deployment-tasks)
    - [Immediate (Within 24 Hours)](#immediate-within-24-hours)
    - [Within First Week](#within-first-week)
    - [Ongoing Maintenance](#ongoing-maintenance)
  - [Continuous Deployment Setup](#continuous-deployment-setup)
    - [Workflow for Updates](#workflow-for-updates)
- [Edit files in your text editor](#edit-files-in-your-text-editor)
- [Test locally by opening HTML in browser](#test-locally-by-opening-html-in-browser)
...
- [Commit with descriptive message](#commit-with-descriptive-message)
  ...
  - [Security Best Practices](#security-best-practices)
    - [Headers (Already Configured in netlify.toml)](#headers-already-configured-in-netlifytoml)
    - [HTTPS](#https)
    - [Form Security](#form-security)
    - [Regular Updates](#regular-updates)
  - [Backup Strategy](#backup-strategy)
    - [Git = Your Backup](#git-your-backup)
