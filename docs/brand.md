...
## Table of Contents
  ...
  - [Color Palette](#color-palette)
    ...
    - [Color Specifications](#color-specifications)
      - [Slate Dark (#343D46)](#slate-dark-343d46)
      - [Slate (#4F5B66)](#slate-4f5b66)
      - [Slate Light (#65737E)](#slate-light-65737e)
      - [Gray (#C0C5CE)](#gray-c0c5ce)
      - [Accent Orange (#FF8800)](#accent-orange-ff8800)
  - [Color Roles & Semantic Tokens](#color-roles-semantic-tokens)
    - [Light Mode](#light-mode)
    - [Dark Mode](#dark-mode)
    - [Usage Examples](#usage-examples)
  - [Typography](#typography)
    - [Font Families](#font-families)
      - [Headings: Oswald](#headings-oswald)
      - [Body: Inter](#body-inter)
    - [Type Scale](#type-scale)
    - [Best Practices](#best-practices)
  - [Logo System](#logo-system)
    - [Logo Variants](#logo-variants)
      - [1. Logo Mark (Icon Only)](#1-logo-mark-icon-only)
      - [2. Horizontal Lockup](#2-horizontal-lockup)
    - [Clear Space](#clear-space)
    - [Color Variations](#color-variations)
      - [On Light Backgrounds](#on-light-backgrounds)
      - [On Dark Backgrounds](#on-dark-backgrounds)
      - [On Accent Backgrounds](#on-accent-backgrounds)
    - [Incorrect Usage](#incorrect-usage)
    - [Logo Files & Exports](#logo-files-exports)
      - [Primary Logos (High Resolution PNG)](#primary-logos-high-resolution-png)
      - [SVG (Vector - Optional)](#svg-vector-optional)
      - [Favicons](#favicons)
  ...
  - [Migration from Old Brand](#migration-from-old-brand)
    - [Color Mapping](#color-mapping)
    - [Migration Strategy](#migration-strategy)
      - [Step 1: Load Compatibility Layer](#step-1-load-compatibility-layer)
      - [Step 2: Update Component-by-Component](#step-2-update-component-by-component)
- [Find all uses of old charcoal](#find-all-uses-of-old-charcoal)
- [Replace with new semantic token](#replace-with-new-semantic-token)
- [OLD: background: var(--primary-charcoal);](#old-background-var-primary-charcoal)
- [NEW: background: var(--brand-slate-dark);](#new-background-var-brand-slate-dark)
      - [Step 3: Test Both Themes](#step-3-test-both-themes)
      - [Step 4: Remove Deprecated File](#step-4-remove-deprecated-file)
