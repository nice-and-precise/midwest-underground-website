...
- [Open your project directory](#open-your-project-directory)
- [Launch VS Code](#launch-vs-code)
- [In separate terminal, launch Claude Code in YOLO mode](#in-separate-terminal-launch-claude-code-in-yolo-mode)
    - [Step 2: Review Current State](#step-2-review-current-state)
    - [Step 3: Use Feature Request Template](#step-3-use-feature-request-template)
  - [📝 General Feature Request Template](#general-feature-request-template)
- [FEATURE REQUEST: [Feature Name]](#feature-request-feature-name)
  - [Context](#context)
  ...
  - [🎨 Specific Feature Templates](#specific-feature-templates)
    - [Dark Mode Toggle](#dark-mode-toggle)
    - [Service Request Form](#service-request-form)
    - [Invoice Payment System](#invoice-payment-system)
  - [✅ Testing & Validation](#testing-validation)
    - [Testing Checklist Template](#testing-checklist-template)
- [TESTING CHECKLIST: [Feature Name]](#testing-checklist-feature-name)
  - [Functional Testing](#functional-testing)
  - [Cross-Browser Testing](#cross-browser-testing)
  - [Responsive Testing](#responsive-testing)
  - [Accessibility Testing](#accessibility-testing)
  - [Performance Testing](#performance-testing)
  - [Security Testing (if applicable)](#security-testing-if-applicable)
  - [Integration Testing](#integration-testing)
  - [User Experience Testing](#user-experience-testing)
  - [Documentation Testing](#documentation-testing)
  - [Git & Deployment Testing](#git-deployment-testing)
  - [Post-Deployment Monitoring](#post-deployment-monitoring)
  - [Test Results](#test-results)
  - [📚 Documentation Requirements](#documentation-requirements)
    - [Automatic Documentation Updates](#automatic-documentation-updates)
      - [1. README.md](#1-readmemd)
    - [[Feature Name]](#feature-name)
      - [2. docs/ARCHITECTURE.md](#2-docsarchitecturemd)
  - [[Feature Name] Implementation](#feature-name-implementation)
      - [3. docs/MAINTENANCE.md](#3-docsmaintenancemd)
  - [Maintaining [Feature Name]](#maintaining-feature-name)
      - [4. In-Code Comments](#4-in-code-comments)
      - [5. Update CHANGELOG](#5-update-changelog)
...
- [Open in browser and manually test](#open-in-browser-and-manually-test)
- [2. Commit changes](#2-commit-changes)
- [3. Push to repository](#3-push-to-repository)
- [4. Deploy (auto-deploy via Netlify/Vercel)](#4-deploy-auto-deploy-via-netlifyvercel)
- [Or manual deploy:](#or-manual-deploy)
- [or](#or)
- [5. Verify deployment](#5-verify-deployment)
- [Visit live site and test feature](#visit-live-site-and-test-feature)
- [6. Monitor for issues](#6-monitor-for-issues)
- [Check error logs, analytics, user feedback](#check-error-logs-analytics-user-feedback)
    - [Rollback Process (If Needed)](#rollback-process-if-needed)
- [If something breaks in production:](#if-something-breaks-in-production)
- [Option 1: Revert commit](#option-1-revert-commit)
- [Option 2: Roll back to previous commit](#option-2-roll-back-to-previous-commit)
- [Option 3: Deploy previous version via Netlify/Vercel UI](#option-3-deploy-previous-version-via-netlifyvercel-ui)
- [Go to deployment history and rollback](#go-to-deployment-history-and-rollback)
  - [💡 Best Practices](#best-practices)
    - [General Guidelines](#general-guidelines)
    - [Code Quality Standards](#code-quality-standards)
    - [Performance Considerations](#performance-considerations)
  - [🎯 Quick Reference](#quick-reference)
    - [Common Claude Code Commands](#common-claude-code-commands)
    - [Git Commit Message Format](#git-commit-message-format)
- [Format: <type>: <subject>](#format-type-subject)
- [Types:](#types)
- [Examples:](#examples)
    - [Lighthouse Audit Quick Run](#lighthouse-audit-quick-run)
- [Install Lighthouse CLI](#install-lighthouse-cli)
- [Run audit](#run-audit)
- [Run audit with specific categories](#run-audit-with-specific-categories)
  - [📞 Getting Help](#getting-help)
    - [If You Get Stuck](#if-you-get-stuck)
  - [🎊 Ready to Add Features](#ready-to-add-features)
