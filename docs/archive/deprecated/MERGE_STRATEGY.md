...
## Table of Contents
  ...
  - [Branch Analysis](#branch-analysis)
    - [Current State (November 23, 2025)](#current-state-november-23-2025)
    - [Branch Details](#branch-details)
      - [1. master (baseline)](#1-master-baseline)
      - [2. feat/brand-refresh](#2-featbrand-refresh)
      - [3. feat/nextjs-migration](#3-featnextjs-migration)
      - [4. feat/takeoff-system](#4-feattakeoff-system)
  - [Recommended Merge Order](#recommended-merge-order)
    - [Phase 1: Foundation Migration (CRITICAL PATH)](#phase-1-foundation-migration-critical-path)
    - [Phase 2: Feature Integration](#phase-2-feature-integration)
    - [Phase 3: Enhancement Integration](#phase-3-enhancement-integration)
  - [Merge Commands Reference](#merge-commands-reference)
    - [Phase 1: Next.js Migration](#phase-1-nextjs-migration)
- [1. Backup master](#1-backup-master)
- [2. Verify feat/nextjs-migration is clean](#2-verify-featnextjs-migration-is-clean)
- [3. Merge to master](#3-merge-to-master)
- [4. Tag release](#4-tag-release)
- [5. Delete remote feature branch (optional)](#5-delete-remote-feature-branch-optional)
- [git push origin --delete feat/nextjs-migration](#git-push-origin-delete-featnextjs-migration)
    - [Phase 2: Takeoff System](#phase-2-takeoff-system)
- [1. Create integration branch](#1-create-integration-branch)
- [2. Rebase takeoff-system onto new master](#2-rebase-takeoff-system-onto-new-master)
- [3. Run tests](#3-run-tests)
- [4. Merge to master](#4-merge-to-master)
- [5. Tag release](#5-tag-release)
    - [Phase 3: Brand Refresh (Adaptation Required)](#phase-3-brand-refresh-adaptation-required)
- [1. Create adaptation branch](#1-create-adaptation-branch)
- [2. Cherry-pick brand-refresh changes](#2-cherry-pick-brand-refresh-changes)
- [3. Adapt to React (manual work required)](#3-adapt-to-react-manual-work-required)
- [- Convert Leaflet.js to React component](#convert-leafletjs-to-react-component)
- [- Update package.json with react-leaflet](#update-packagejson-with-react-leaflet)
- [- Create app/components/ServiceAreaMap.tsx](#create-appcomponentsserviceareamaptsx)
- [- Import in homepage](#import-in-homepage)
- [4. Test](#4-test)
- [5. Merge to master](#5-merge-to-master)
- [6. Tag release](#6-tag-release)
  - [Conflict Resolution Guidelines](#conflict-resolution-guidelines)
    - [Expected Conflicts](#expected-conflicts)
      - [Phase 1 (Next.js Migration)](#phase-1-nextjs-migration)
      - [Phase 2 (Takeoff System)](#phase-2-takeoff-system)
      - [Phase 3 (Brand Refresh)](#phase-3-brand-refresh)
    - [Conflict Resolution Strategy](#conflict-resolution-strategy)
  - [Testing Requirements](#testing-requirements)
    - [Pre-Merge Testing (Each Phase)](#pre-merge-testing-each-phase)
      - [Phase 1 (Next.js Migration)](#phase-1-nextjs-migration)
      - [Phase 2 (Takeoff System)](#phase-2-takeoff-system)
      - [Phase 3 (Brand Refresh)](#phase-3-brand-refresh)
...
- [Restore master from backup](#restore-master-from-backup)
    - [If Phase 2 Fails](#if-phase-2-fails)
- [Revert the merge commit](#revert-the-merge-commit)
    - [If Phase 3 Fails](#if-phase-3-fails)
- [Revert the merge commit](#revert-the-merge-commit)
  - [Post-Merge Tasks](#post-merge-tasks)
    - [After Phase 1 (Next.js Migration)](#after-phase-1-nextjs-migration)
    - [After Phase 2 (Takeoff System)](#after-phase-2-takeoff-system)
    - [After Phase 3 (Brand Refresh)](#after-phase-3-brand-refresh)
  ...
  - [Alternative Strategies](#alternative-strategies)
    - [Option B: Parallel Integration (Faster but Riskier)](#option-b-parallel-integration-faster-but-riskier)
    - [Option C: Squash Everything (Cleaner History)](#option-c-squash-everything-cleaner-history)
    - [Option D: Keep Separate Codebases (No Merge)](#option-d-keep-separate-codebases-no-merge)
  - [Timeline Estimate](#timeline-estimate)
    - [Conservative Timeline (Recommended)](#conservative-timeline-recommended)
    - [Aggressive Timeline (Higher Risk)](#aggressive-timeline-higher-risk)
  - [Success Metrics](#success-metrics)
    - [Definition of Done](#definition-of-done)
    - [Quality Gates](#quality-gates)
  - [Questions & Answers](#questions-answers)
    - [Q: Why not merge all at once?](#q-why-not-merge-all-at-once)
    - [Q: Can we skip brand-refresh?](#q-can-we-skip-brand-refresh)
    - [Q: What if we want a different order?](#q-what-if-we-want-a-different-order)
    - [Q: Should we delete feature branches after merge?](#q-should-we-delete-feature-branches-after-merge)
    - [Q: What about git history cleanliness?](#q-what-about-git-history-cleanliness)
