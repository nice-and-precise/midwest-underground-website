...
## Table of Contents
  ...
  - [Database Schema](#database-schema)
    ...
    - [Database File Locations](#database-file-locations)
    - [Schema Management Commands](#schema-management-commands)
- [Generate Prisma Client (run after schema changes)](#generate-prisma-client-run-after-schema-changes)
- [Push schema to database (no migrations)](#push-schema-to-database-no-migrations)
- [Open Prisma Studio (database GUI)](#open-prisma-studio-database-gui)
- [Create migration (production)](#create-migration-production)
  ...
  - [Project Structure](#project-structure)
    ...
    - [/src/components - React Components](#srccomponents-react-components)
    - [/src/lib - Utilities](#srclib-utilities)
    - [/src/types - TypeScript Types](#srctypes-typescript-types)
...
- [Checkout migration branch](#checkout-migration-branch)
- [Install dependencies](#install-dependencies)
- [Set up environment variables](#set-up-environment-variables)
- [Edit .env with your database URL and secrets](#edit-env-with-your-database-url-and-secrets)
- [Generate Prisma Client](#generate-prisma-client)
- [Create database schema](#create-database-schema)
- [(Optional) Seed database with sample data](#optional-seed-database-with-sample-data)
- [Start development server](#start-development-server)
    - [Environment Variables](#environment-variables)
- [Database](#database)
- [DATABASE_URL="postgresql://user:pass@localhost:5432/midwest_underground"  # PostgreSQL for prod](#database_urlpostgresqluserpasslocalhost5432midwest_underground-postgresql-for-prod)
- [NextAuth](#nextauth)
- [App](#app)
...
- [After editing prisma/schema.prisma:](#after-editing-prismaschemaprisma)
- [Generate Prisma Client (TypeScript types)](#generate-prisma-client-typescript-types)
- [Update database schema](#update-database-schema)
- [View changes in Prisma Studio](#view-changes-in-prisma-studio)
  - [API Routes](#api-routes)
    - [Authentication](#authentication)
    - [HDD Operations (Coming Soon)](#hdd-operations-coming-soon)
  ...
  - [Testing Checklist](#testing-checklist)
    ...
    - [Phase 2: Authentication (Coming Soon)](#phase-2-authentication-coming-soon)
    - [Phase 3: API Routes (Coming Soon)](#phase-3-api-routes-coming-soon)
    - [Phase 4: Dashboard (Coming Soon)](#phase-4-dashboard-coming-soon)
    - [Phase 5: Deployment (Coming Soon)](#phase-5-deployment-coming-soon)
