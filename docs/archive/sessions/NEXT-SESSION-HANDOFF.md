...
## Table of Contents
  ...
  - [📋 What Needs to Happen Next](#what-needs-to-happen-next)
    - [Primary Task: Merge to Master](#primary-task-merge-to-master)
- [Read the merge plan first](#read-the-merge-plan-first)
- [Execute fast-forward merge (recommended)](#execute-fast-forward-merge-recommended)
- [Verify](#verify)
  - [📂 Important Files to Read](#important-files-to-read)
  - [🔍 Recent Git History](#recent-git-history)
  - [🗂️ Untracked Files (Remaining)](#untracked-files-remaining)
  - [🎯 Recommended Workflow for Next Session](#recommended-workflow-for-next-session)
    - [Step 1: Activate Serena Project](#step-1-activate-serena-project)
- [Serena will auto-activate: midwest-underground-website](#serena-will-auto-activate-midwest-underground-website)
    - [Step 2: Review Context](#step-2-review-context)
- [Read the merge plan (CRITICAL)](#read-the-merge-plan-critical)
- [Review recent session results](#review-recent-session-results)
    - [Step 3: Execute Merge](#step-3-execute-merge)
- [Follow MERGE-PLAN.md Option 1 (fast-forward)](#follow-merge-planmd-option-1-fast-forward)
    - [Step 4: Verify Merge](#step-4-verify-merge)
- [Build verification](#build-verification)
- [Test verification](#test-verification)
- [Manual check](#manual-check)
- [Visit http://localhost:3000](#visit-httplocalhost3000)
    - [Step 5: Post-Merge Actions](#step-5-post-merge-actions)
- [Create release tag](#create-release-tag)
- [Optional: Delete feature branch](#optional-delete-feature-branch)
  - [🔧 Serena MCP Memories Available](#serena-mcp-memories-available)
  - [🚨 Important Notes](#important-notes)
    - [Before Merging](#before-merging)
    - [After Merging](#after-merging)
    - [If Issues Occur](#if-issues-occur)
  - [📊 Project Statistics](#project-statistics)
  - [🎓 What This Merge Accomplishes](#what-this-merge-accomplishes)
    - [Migration Complete](#migration-complete)
    - [Features Delivered](#features-delivered)
    - [Production Ready](#production-ready)
  - [🔮 After Merge: Optional Next Steps](#after-merge-optional-next-steps)
...
- [Cleanup (optional after merge)](#cleanup-optional-after-merge)
  - [🎯 Success Criteria for Next Session](#success-criteria-for-next-session)
  - [📞 Questions & Troubleshooting](#questions-troubleshooting)
    - [Q: What if the merge fails?](#q-what-if-the-merge-fails)
    - [Q: Should I delete feat/nextjs-migration after merge?](#q-should-i-delete-featnextjs-migration-after-merge)
    - [Q: Can I merge directly without reading MERGE-PLAN.md?](#q-can-i-merge-directly-without-reading-merge-planmd)
    - [Q: What if tests fail on master after merge?](#q-what-if-tests-fail-on-master-after-merge)
    - [Q: How long will the merge take?](#q-how-long-will-the-merge-take)
